...
<img data-id="pulsefig" class='r-stretch' src="images/waves.png">
<p>&nbsp;</p>
...
--
<!-- ![](images/waves_radial.png) .element: height=30px -->
<!--          <img data-id="pulsefig" class="r-stretch" src="images/waves_radial.png">
        </section>

        <section data-auto-animate>
          <p data-id="question" class="r-fit-text">When would we need the 1/3rd rule to calculate mean pressure?</p>
        ...
        <section data-auto-animate>
          <p data-id="question" class="r-fit-text">When would we not need the 1/3rd rule to calculate mean pressure?</p>
...
<!-- <img class="r-stretch" src="images/ArterialVenousPressures.png"> -->
...
<!--	<section data-auto-animate data-notes="Liquids and gases will move from an area of high pressure to an area of low pressure. This bulk flow is the driving mechanism behind movement of blood through the arteries.">
			...
			<p>Blood flows due to a pressure gradient. That is, a fluid (liquid or gas) will travel from a region of higher pressure to a region of lower pressure.</p>

			<img class="r-stretch" src="images/bulkflow.jpg">
		
			<p><a class='citation' href="https://sites.psu.edu/musingsofameteorologist/2013/02/05/how-does-air-move/">sites.psu.edu (2020)</a></h6>
		</section>
		...
		<section data-auto-animate>
			...
			<p class="fragment">For those that have done a little physics, you may recognise this from electrical work and Ohm's law:
		...
		<section data-auto-animate>
			...
			<span data-id="eqresistance">
			$$\mathrm{resistance}\propto \dfrac{1}{\mathrm{radius}^4}$$
			</span>

			<p>Example: If we halve the radius of a vessel, we increase resistance by $2^{4}=16$, resulting in $1/16^{th}$ of the flow.</p>
		</section>
		...
		<section data-auto-animate data-notes="This means that a change in radius has a dramatic effect on resistance.">
			...
			<p class="fragment">The important thing to remember: resistance is directly proportional to the length of the tube, and inversely proportional to the fourth power of radius.</p>
		</section>
		...
		<section data-auto-animate data-notes="Flow is proportional to the pressure difference. If we consider the venous system near atmospheric pressure (0 mmHg, though actually pressure in the venous system is a little higher than this), then the driving force for blood flow is the arterial pressure minus 0 mmHg. Sympathetic stimulation changes the resistances of vessels. Increased resistance decreases flow and decreased resistance increases flow. The pressure at which there is zero flow is called the critical closing pressure (this is more applicable in the intracrannial space.">
			...
			<div class="r-stack">
			<img class="r-stretch" data="fragment fade-out" data-fragment-index="0" src="images/flowandpressure0.jpg">
			<img class="r-stretch" data="fragment current-visible" data-fragment-index="0" class="fragment" src="images/flowandpressure1.jpg">
			</div>
		...
		lower and lower as we travel through the systemic vasculature. The arterioles have highly variable resistance, and therefore can regulate the pressure drop, and thus blood flow across this segment.">
			...
			<img class="r-stretch" src="images/PressureFlow.png">
...
<!--
		...
		<section data-auto-animate="">
			...
			<p>Factors determining blood pressure and total peripheral resistance are anything that changes:</p>
	...
	<section>
		<section data-auto-animate>
			...
			<p>Dr Mark Butlin (PhD, BE, SFHEA)</p>
		</section>
	</section>
...
<!--	<section data-auto-animate data-notes="It is not possible to do this learning outcome true service in the time available. A brief overview is provided here. It is highly recommended that you consult the Guyton \& Hall textbook (available on-line through the library). Guyton was a cardiovascular physiologist and that strength is apparent in the general medical textbook.">
			...
			<img class="r-stretch" src="images/guyton.jpg">
		...
		<section data-auto-animate data-notes="When thinking of venous return, it is usually referring to return of blood from the systemic vasculature via the inferior and superior vena cava to the right heart. However, this same flow must logically also return to the left heart after travelling through the pulmonary circulation.">
			...
			<img class="r-stretch" src="images/venousreturn.png">
		...
		<section data-auto-animate>
			<h3 class="title">LO5: Mechanisms that regulate blood pressure - neural and hormonal</h3>
			<h4 class="subtitle">Altered venous return to the heart</h4>
			<p>Venous return can be increased through a number of mechanisms:</p>
			<ul>
		...
		<section data-auto-animate>
			<h3 class="title">LO5: Mechanisms that regulate blood pressure - neural and hormonal</h3>
			<h4 class="subtitle">Altered venous return to the heart</h4>
			<p>Changes in venous return alter arterial blood pressure through:</p>
			<ul>
...
<!-- <section data-auto-animate data-notes="Centers  that regulate the cardiovascular system are spread across the brain, though a large concentration of neurons controlling breathing and the cardiovascular system are centred in the lower brain, namely the medulla (5) and spinal cord (6)."> 		<h3 class="title">LO5: Mechanisms that regulate blood pressure - neural and hormonal</h3>
			...
			<p>Central cardiorespiratory control: across the brain.</p>
			
			<p>Important centres in the lower brain: (5) medulla (6) spinal cord.</p>

			<img data-id="brain" class="r-stretch" src="images/BrainFrontalCoronal.jpg">
...
<div class='media'>
    ...
    <div class='description'>
			...
			<span class="fragment">
				<p>These areas <em>process inputs</em> to invoke these functional responses. <em>They do not invoke these responses without an input.</em></p>
			</span>
    </div>
    <div class='credit'>
        <p>Guyton and Hall Textbook of Medical Physiology</p>
...
<!--
		<section data-auto-animate>
			...
			<img class="r-stretch" src="images/CardiacNervousInput.png">
		...
		<section data-auto-animate>
			...
			<img class="r-stretch" src="images/CardiacNervousInput2.png">
			<h6 class="citation">Guyton and Hall Textbook of Medical Physiology</h6>
		</section>
		...
		<section data-auto-animate>
			...
			<p class="blockquote">Besides acting directly on the heart rate and cardiac contractility, the central nervous system (sympathetic and parasympathetic outputs) innervate the resistance (muscular) arteries of the body.</p>
		</section>
		...
		<section data-auto-animate>
			...
			<p>Resistance ($R$) and corollary of Poiseuille's Law</p>
			...
			<p>The important thing to remember: resistance is directly proportional to the length of the tube, and
				inversely proportional to the fourth power of radius.</p>
		</section>

		<section data-auto-animate data-visibility="hidden">
			<h3 class="title">LO5: Mechanisms that regulate blood pressure - neural and hormonal</h3>
			<h4 data-id="sub" class="subtitle">Sympathetic and parasympathetic nervous input to peripheral arteries</h4>
			<img class="r-stretch" src="images/WindkesselTextBook.png">
			<!-- <img class="r-stretch" src="images/Windkessel.tex"> -->
<!--			<em>Windkessel</em> representation.
		...
		<section data-auto-animate data-notes="Sympathetic innervation causes vasoconstriction at the level of the small arteries, arterioles, and veins. In some tissues the precapillary sphincters and metarterioles are innervated. Capillaries do not receive direct sympathetic input (after all, there is no smooth muscle there).">
			<h3 class="title">LO5: Mechanisms that regulate blood pressure - neural and hormonal</h3>
			<h4 data-id="sub" class="subtitle">Sympathetic and parasympathetic nervous input to peripheral arteries</h4>
			<img class="r-stretch" src="images/SNA_BloodVessels.png">
			<div class="r-stack">
		...
		<section data-auto-animate>
			<h3 class="title">LO5: Mechanisms that regulate blood pressure - neural and hormonal</h3>
			<h4 data-id="sub" class="subtitle">Sympathetic and parasympathetic nervous input - rate of response</h4>
			<p data-id="question">Why are such rapid changes in blood pressure required?</p>
		</section>

		<section data-auto-animate>
			<h3 class="title">LO5: Mechanisms that regulate blood pressure - neural and hormonal</h3>
			<h4 data-id="sub" class="subtitle">Sympathetic and parasympathetic nervous input - rate of response</h4>
			<p data-id="question">How are such rapid changes in blood pressure made?</p>
		</section>
		...
		<section data-auto-animate>
			...
			<p>A rapid rise in blood pressure is invoked by:</p>
	...
	<section data-auto-animate>
		...
		<img class="r-stretch" src="images/SNAandPNA_Sherwoord.png">
	...
	<section data-auto-animate>
		...
		<img class="r-stretch" src="images/baroreceptor.png">
		<div class="r-stack">
		<ul class="fragment fade-out" data-fragment-index="0">
		...
		<span class="fragment current-visible" data-fragment-index="0">
				<p>$\uparrow$ pressure $\longrightarrow~\uparrow$ stretch $\longrightarrow$ brain</p>
				
				<p>$\downarrow$ sympathetic drive</p>
				
				<p>$\uparrow$ parasympathetic drive</p>
		</span>
		</div>
		<h6 class="citation">Guyton and Hall Textbook of Medical Physiology.</h6>
	</section>
	...
	<section data-auto-animate>
		<h3 class="title">LO5: Mechanisms that regulate blood pressure - neural and hormonal</h3>
		<h4 data-id="sub" class="subtitle">Baroreceptor reflex</h4>
		<img class="r-stretch" src="images/BaroreceptorSherwood.png">
		<h6 class="citation">Sherwood L. <em>Human Physiology: From Cells to Systems. 4th Ed</em></h6>
	</section>
	...
	<section data-auto-animate>
		<h3 class="title">LO5: Mechanisms that regulate blood pressure - neural and hormonal</h3>
		<h4 data-id="sub" class="subtitle">Baroreceptor reflex</h4>
		<img class="r-stretch" src="images/BaroreceptorFiringSherwood.png">
		<h6 class="citation">Sherwood L. <em>Human Physiology: From Cells to Systems. 4th Ed</em></h6>
	</section>
	...
	<section data-auto-animate data-notes="Baroreflex response curve. Different levels of blood pressure activate the baroreflex complex to a different extent.">
		<h3 class="title">LO5: Mechanisms that regulate blood pressure - neural and hormonal</h3>
		<h4 data-id="sub" class="subtitle">Baroreceptor reflex</h4>
		<img class="r-stretch" src="images/BaroreflexResponseCurve.png">
		<h6 class="citation">Guyton and Hall Textbook of Medical Physiology.</h6>
	</section>
...
<!--
	...
	<section data-auto-animate data-notes="Baroreceptor dennervation in the dog shows the removal of the buffering reflex that the baroreceptors provide to	counteract changes in blood pressure." data-visibility="hidden">
		...
		<img class="r-stretch" src="images/Cowley1973.png">
	...
	<section data-auto-animate data-notes="Baroreceptor dennervation in the dog shows the removal of the buffering reflex that the baroreceptors provide to counteract changes in blood pressure." data-visibility="hidden">
		<h3 class="title">LO5: Mechanisms that regulate blood pressure - neural and hormonal</h3>
		<h4 data-id="sub" class="subtitle">Baroreceptors and short-term control of arterial blood pressure</h4>
		<img class="r-stretch" src="images/Cowley1973_2.png">
		<h6 class="citation">Cowley AW Jr et al. Role of baroreceptor reflex in daily control of arterial blood pressure and other variables in dogs. <em>Circ Res.</em> 1973;32(5):564-76.</h6>
	</section>
...
%     \end{frame}
	...
	<section data-auto-animate>
		...
		<p>If total blood volume is increased, blood pressure will increase. This is not a rapid method to alter blood pressure, as it takes a longer period of time to alter blood volume (as opposed to altering venous return, or chemosensor and baroreceptor feedback).</p>
	</section>

	<section data-auto-animate>
		<h3 class="title">LO5: Mechanisms that regulate blood pressure - neural and hormonal</h3>
		<h4 data-id="sub" class="subtitle">The role of blood volume in systemic arterial blood pressure</h4>
		<p>Functions of the kidneys</p>
		<ul>
	...
	<section data-auto-animate>
		...
		<p>Vasoconstrictor nerve terminals release predominantly norephinephrine, a potent vasoconstrictor acting on alpha
		adrenergic receptors of vascular smooth muscle.</p>
	</section>
	...
	<section data-auto-animate>
		...
		<h5>Antidiruetic hormone (ADH) or vasopressin</h5>
			<p>Produced by the hypothalamus (in the brain), transported to the pituitary gland where it is released into the blood.</p>
		<div class="r-stack">
		<span class="fragment fade-out" data-fragment-index="0">
			<p>Induced by:</p>
			<ul>
...
<!--
	<section>
		...
		<img class="r-stretch" src="images/MAPoverview.png">
		<h6 class="citation">Sherwood L. <em>Human Physiology: From Cells to Systems. 4th Ed</em>.</h6>
	</section>
	...
	<section data-notes="Time course of determinants of mean arterial pressure.">
		<!-- <h3 class="title">Bringing it all together</h3>
			<h4 data-id="sub" class="subtitle">Regulating mean arterial pressure: An overview</h4> 
		<img class="r-stretch" src="images/MAPoverviewTiming.png">
		<h6 class="citation">Guyton and Hall Textbook of Medical Physiology.</h6>
	</section>
...
% <section data-auto-animate>
	...
	% <section data-auto-animate>
		...
		<section data-auto-animate data-notes="Mechanisms resulting in drastic fall in mean pressure (circulatory shock) such that blood flow to organs is not maintained at an adequate level.>
			...
			<img class="r-stretch" src="images/CirculatoryShock_Sherwood.png">
			<h6 class="citation">Sherwood L. <em>Human Physiology: From Cells to Systems. 4th Ed</em>.</h6>
		</section>
		...
		<section data-auto-animate data-notes="Resulting cardiovascular regulation pathway of a large loss of blood (haemorrhage).">
			...
			<img class="r-stretch" src="images/hemorrhage_Sherwood.png">
			<h6 class="citation">Sherwood L. <em>Human Physiology: From Cells to Systems. 4th Ed</em>.</h6>
		</section>
		...
		<section data-auto-animate>
			...
			<h4 class="subtitle"></h4>
			<p>To alter systemic arterial blood pressure (here mean arterial pressure, MAP), we must change one or more of:</p>
		...
		<section data-auto-animate>
			<h3 class="title">Summary</h3>
			<h4 class="subtitle"></h4>
			<p>Venous return mechanisms (where venous return is altered, e.g. by sympathetic stimulation of the venous smooth muscle; skeletal muscle pump; respiratory pump;). For increased venous return (opposite for decreased venous return):</p>
			<ul>
		...
		<p>There must be a reason (a cause, an input to the central nervous system) for the changes in sympathetic and parasympathetic outflow to occur.</p>
		</section>
...
<tr>
<td>chemoreceptors</td><td>central (brain) and peripheral (carotid/aorta)</td><td>blood O<sub>2</sub>, CO<sup>2</sup>, H<sup>+</sup></td>
</tr>
<tr>
